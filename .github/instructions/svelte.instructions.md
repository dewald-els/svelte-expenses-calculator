---
description: Whenever there is an architectural or code design choice to be made. New features, bug fixes, creating new code files.
# applyTo: 'Whenever there is an architectural or code design choice to be made. New features, bug fixes, creating new code files.' # when provided, instructions will automatically be added to the request context when the pattern matches an attached file
---

<!-- Tip: Use /create-instructions in chat to generate content with agent assistance -->

Always use TypeScript for logic code files. Use Svelte for UI code files. Use Tailwind and CSS for styling code files. Use Markdown for documentation code files. Use JSON for configuration code files.

Adhere to the svelte best practices found below. Here is the link to the source: https://svelte.dev/docs/svelte/best-practices
